...
void main() {
  group('LargeError', () {
    ...
    test('error message', () {
      ...
      expect(
        errorMessageFromError(error1),
        equals("Important debug description of what went wrong."),
      );

      final error2 = LargeError.case2(arg1: "foobar");
      expect(
        errorMessageFromError(error2),
        equals("Important debug description of what went wrong, arg: 'foobar'"),
      );
    });
  });
}
